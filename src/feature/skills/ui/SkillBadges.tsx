                ...
                >
                    <div className="relative mx-4 w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
                        ...
                        >
                            ...
                            <div
                                className={"mt-3 h-[3px] w-full rounded-full opacity-95 shadow-[0_0_24px_rgba(255,255,255,0.12)] " + skills[openIndex].color}/>
                                ...
                                <div className="mt-4 flex flex-wrap gap-2">
                                    {skills[openIndex].tags.map((t) => (
                                        <a
                                            ...
                                            className="inline-flex items-center rounded-full bg-white/5 px-2.5 py-0.5 text-[11px] font-medium text-zinc-200 ring-1 ring-white/10 hover:bg-white/20 hover:ring-white/30 transition cursor-pointer"

...
export const skills: Skill[] = [
  {
    ...
    short: "Go, Python, Ruby, TypeScript, Domain Driven Design, Clean Architecture, REST/gRPC",
    description:
  ...
  {
    title: "Frontend / Web",
    short: "Next.js/React, TypeScript, BFF",
    description:
      "Next.jsでのアクセシビリティ配慮のUI実装。TypeScriptでのBFF/型安全(Zod)を活用。画像最適化・コード分割・メモ化等でパフォーマンスを向上。",
    color: "bg-sky-700",
    tags: [
      "Next.js",
      "React",
  ...
  {
    title: "Community Management / Event Management",
